...
{Fore.GREEN + Style.BRIGHT}║    ╚═════╝ ╚═╝  ╚═╝ ╚══╝╚══╝ ╚═╝  ╚═══╝                       ║
{Fore.GREEN + Style.BRIGHT}║                                                              ║
{Fore.BLUE + Style.BRIGHT}║              ⚡ TOKEN SETUP BOT ACTIVATED ⚡                  ║
{Fore.GREEN + Style.BRIGHT}║                                                              ║
...
{Fore.GREEN + Style.BRIGHT}╚══════════════════════════════════════════════════════════════╝{Style.RESET_ALL}
    ...
    def save_tokens(self, new_accounts):
        ...
        try:
            ...
            self.log_status("Save Tokens", "success", "Tokens saved successfully")
    ...
    async def process_accounts(self, email: str, use_proxy: bool, rotate_proxy: bool):
        ...
        timestamp = f"{Fore.CYAN + Style.BRIGHT}╭─[{datetime.now().astimezone(wib).strftime('%x %X %Z')}]{Style.RESET_ALL}{Fore.WHITE + Style.BRIGHT} ─ {Style.RESET_ALL}"
    ...
    async def main(self):
        try:
            ...
            separator = f"{Fore.CYAN + Style.BRIGHT}✦{Style.RESET_ALL}" * 25
...
if __name__ == "__main__":
    try:
        ...
        print(
            ...
            f"{Fore.RED + Style.BRIGHT}🛑 SETUP STOPPED BY USER{Style.RESET_ALL}"
            f"\n{Fore.CYAN + Style.BRIGHT}╰─⋆ {Fore.MAGENTA}DAWN-BOT BY DROPSTERMIND{Style.RESET_ALL}"                                     
        )
